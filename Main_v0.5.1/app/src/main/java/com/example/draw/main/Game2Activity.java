...
import com.example.draw.main.R;
import com.example.draw.main.ResultActivity;
...
public class Game2Activity extends AppCompatActivity {
    ...
    private Button answerButton15;
    private String questions[][] = new String[30][16];
    TextView textTIme;
    ProgressBar pb;
    int time;
    int count;
    ...
    private double suuji[][] = new double[16][8];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);setContentView(R.layout.activity_game2);
        ...
        answerButton11 =  findViewById(R.id.button11);
        answerButton12 =  findViewById(R.id.button12);
        answerButton13 =  findViewById(R.id.button13);
        answerButton14 =  findViewById(R.id.button14);
        answerButton15 =  findViewById(R.id.button15);
...
//        }
    ...
    private int[] setQuizText(int NumberOfSection){
        int rndNum[] = createRandomArray(15, 1);
        //選択肢をセット
        ...
        answerButton11.setText(questions[NumberOfSection][rndNum[10]]);
        answerButton12.setText(questions[NumberOfSection][rndNum[11]]);
        answerButton13.setText(questions[NumberOfSection][rndNum[12]]);
        answerButton14.setText(questions[NumberOfSection][rndNum[13]]);
        answerButton15.setText(questions[NumberOfSection][rndNum[14]]);
...
//                }
            ...
            if(Num[number] <= NumberOfAnswer){
                drawEnGraphView(graph, suuji[Num[number]][0], suuji[Num[number]][6], suuji[Num[number]][7], suuji[Num[number]][1], suuji[Num[number]][2], suuji[Num[number]][3], suuji[Num[number]][4], suuji[Num[number]][5], Color.parseColor("#00adff"));
                answer_count++;
            }
            else {
